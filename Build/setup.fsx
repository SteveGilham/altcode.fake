#r "paket:
nuget Fake.Core.Environment >= 5.10.1
nuget Fake.Core.Process >= 5.10.1
nuget Fake.DotNet.Cli >= 5.10.1
nuget Fake.DotNet.NuGet >= 5.10.1
...
nuget Fake.Core.Environment >= 5.10.1
nuget Fake.Core.Process >= 5.10.1
nuget Fake.DotNet.AssemblyInfoFile >= 5.10.1
nuget Fake.DotNet.Cli >= 5.10.1
nuget Fake.DotNet.FxCop >= 5.10.1
nuget Fake.DotNet.MSBuild >= 5.10.1
nuget Fake.DotNet.NuGet >= 5.10.1
nuget Fake.DotNet.Testing.NUnit >= 5.10.1
